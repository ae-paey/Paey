										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
											<tr>
												<td class="p30-15" style="padding: 50px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h2 center pb20" style="color:#050505; font-family:'Roboto', Arial,sans-serif; font-size:28px; line-height:34px; text-align:left; padding-bottom:20px;">Hello {{ $user['name'] }},</td>
														</tr>
														<tr>
															<td class="text center pb30" style="color:#666666; font-family:'Roboto', Arial,sans-serif; font-size:16px; line-height:28px; text-align:left; padding-bottom:30px;">Welcome to {{ config('app.name') }}. Your registered email address is {{ $user['email'] }}. Kindly complete your profile by clicking on the below link to start receiving pæyment</td>
														</tr>
														<!-- Button -->
														<tr>
															<td align="center">
