										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30 p30-15" bgcolor="#ffffff" style="padding:30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h3 pb25" style="color:#050505; font-family:'Roboto', Arial,sans-serif; font-size:20px; line-height:28px; text-align:left; padding-bottom:25px;">Dear {{ config('app.name') }} Customer Support,</td>
														</tr>
														<tr>
															<td class="text pb25" style="color:#666666; font-family:'Roboto', Arial,sans-serif; font-size:16px; line-height:28px; text-align:left; padding-bottom:7px;">{{ $contact->name }} has sent you a new message from Pæy Contact Form from {{ $contact->email }} with {{ $contact->subject }} as the Mail Subject</td>
														</tr>
														<tr>
